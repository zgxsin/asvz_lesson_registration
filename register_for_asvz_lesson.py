...
def register_for_asvz_lesson(lesson_id, frequency) -> None:
    """
    ...
    print("The lesson registration has been complete!")
...
def main():
    ...
    my_parser.add_argument(
        '-f', '--frequency', help='The refreshing frequency for registration.', default=2)
    my_args = my_parser.parse_args()
    register_for_asvz_lesson(my_args.id, my_args.frequency)
